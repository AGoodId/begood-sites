...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.simple_input'
        db.add_column(u'begood_sites_sitesettings', 'simple_input',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['begood.Template']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.simple_input'
        db.delete_column(u'begood_sites_sitesettings', 'simple_input_id')
