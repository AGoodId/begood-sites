...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.stylesheet'
        db.add_column(u'begood_sites_sitesettings', 'stylesheet',
                      self.gf('django.db.models.fields.FilePathField')(default='', path=('/Users/andreas/.virtualenvs/showroom2/src/begood-sites/begood_sites/static/less',), max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.stylesheet'
        db.delete_column(u'begood_sites_sitesettings', 'stylesheet')
    ...
    models = {
        ...
        u'begood_sites.sitesettings': {
            ...
            'stylesheet': ('django.db.models.fields.FilePathField', [], {'path': "('/Users/andreas/.virtualenvs/showroom2/src/begood-sites/begood_sites/static/less',)", 'max_length': '100', 'blank': 'True'}),
