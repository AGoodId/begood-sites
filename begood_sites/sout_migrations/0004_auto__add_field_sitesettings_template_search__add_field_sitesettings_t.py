...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.template_search'
        db.add_column(u'begood_sites_sitesettings', 'template_search',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['begood.Template']),
                      keep_default=False)

        # Adding field 'SiteSettings.template_404'
        db.add_column(u'begood_sites_sitesettings', 'template_404',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['begood.Template']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.template_search'
        db.delete_column(u'begood_sites_sitesettings', 'template_search_id')

        # Deleting field 'SiteSettings.template_404'
        db.delete_column(u'begood_sites_sitesettings', 'template_404_id')
