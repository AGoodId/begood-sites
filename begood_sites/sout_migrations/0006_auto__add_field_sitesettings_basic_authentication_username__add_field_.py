...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.basic_authentication_username'
        db.add_column(u'begood_sites_sitesettings', 'basic_authentication_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SiteSettings.basic_authentication_password'
        db.add_column(u'begood_sites_sitesettings', 'basic_authentication_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.basic_authentication_username'
        db.delete_column(u'begood_sites_sitesettings', 'basic_authentication_username')

        # Deleting field 'SiteSettings.basic_authentication_password'
        db.delete_column(u'begood_sites_sitesettings', 'basic_authentication_password')
