...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'begood_sites_sitesettings', (
            ('site', self.gf('django.db.models.fields.related.OneToOneField')(related_name='settings', unique=True, primary_key=True, to=orm['sites.Site'])),
            ('extra_html_head', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'begood_sites', ['SiteSettings'])


    def backwards(self, orm):
        # Deleting model 'SiteSettings'
        db.delete_table(u'begood_sites_sitesettings')
